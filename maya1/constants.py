...
SNAC_BATCH_SIZE = 4  # Increased from 2 to 4 for better efficiency with optimized memory
SNAC_BATCH_TIMEOUT_MS = 30  # Reduced from 50ms to 30ms for faster response

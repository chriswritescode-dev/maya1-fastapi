...
SNAC_BATCH_SIZE = 8  # Increased to 8 for better throughput with fixed memory usage
SNAC_BATCH_TIMEOUT_MS = 20  # Reduced to 20ms for faster response with larger batches
